...
def we_func1():
	print('This is func1 from whatever.py!')
	print('The name of the __name__ variable is {}!'.format(__name__))



def we_func2():
	print('This is func2 from whatever.py!')
	print('The name of the __name__ variable is {}!'.format(__name__))


def we_func3():
	print('This is func3 from whatever.py!')
	print('The name of the __name__ variable is {}!'.format(__name__))


def main():
	print('\nYou just ran whatever.py directly as a main script.')
	print('The name of the __name__ variable is {}!'.format(__name__))
